...
def update_dynamic_ui(password_len, msg="", scramble_char=None, is_error=False, cursor_on=False):
    ...
    if is_error:
        ...
        title_start = (box_width - len(box_title)) // 2
        top_border = f"╭{'─'*title_start}\033[1;37m{box_title}\033[1;31m{'─'*(box_width - 2 - title_start - len(box_title))}╮"
            ...
            while True:
                ...
                if ch == '\n' or ch == '\r':
                    ...
                    if proc.returncode == 0:
                        update_dynamic_ui(len(password), "\033[1;37m[✓] ACCESS GRANTED. INITIATING METAMORPHOSIS...\033[0m")
                        time.sleep(1)
                        sys.stdout.write("\033[2J\033[H\033[?25h") 
                        sys.exit(0)
                    else:
                        password = ""
                        msg = "\033[1;37m[X] ACCESS DENIED. INCORRECT KEY.\033[0m"
